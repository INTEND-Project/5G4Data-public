...
- Package-only implementation under `SimulatorAgentPackages/5g4data-intent-observation-langgraph-generating-agent`.
...
```bash
API_SERVER_ENABLED=true npx tsx src/index.ts --port 3032
```
