...
export interface AgentTurnResult {
  ...
  /** Per-turn UUID. */
  turnId?: string;
  /** LangSmith run id for the agent_turn trace (when tracing is enabled). */
  langsmithTraceId?: string;
  /** @deprecated Alias of langsmithTraceId for Controller/clients that still read mlflowTraceId. */
  ...
  /** Trace tags accumulated during the turn. */
  traceTags?: Record<string, string>;
  /** Trace metadata accumulated during the turn. */
