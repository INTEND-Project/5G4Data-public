...
- Suggest thresholds from user context when stated; otherwise use latency **50 ms** (`quan:smaller`) and bandwidth **300 mbit/s** (`quan:greater`). The postprocessor applies these defaults when values are missing.
