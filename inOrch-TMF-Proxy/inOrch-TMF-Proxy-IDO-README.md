# inOrch-TMF-Proxy: IDO Planner Deployment Guide

This document describes the changes made to successfully deploy the IDO (Intent Driven Orchestration) planner to a Kubernetes cluster, specifically for the inOrch-TMF-Proxy integration project.
