...
echo "    inserv"
echo ""
echo "To run the container in test mode with a fixed name and /logs endpoint enabled:"
echo "  docker run -d --network host \\"
echo "    --name inserv \\"
echo "    -e GRAPHDB_BASE_URL=http://start5g-1.cs.uit.no:7200 \\"
echo "    -e GRAPHDB_REPOSITORY=intents_and_intent_reports \\"
echo "    -e INSERV_TEST_MODE=true \\"
echo "    -e ENABLE_LOG_ENDPOINT=true \\"
echo "    -e INSERV_LOG_FILE=/app/logs/inserv.log \\"
echo "    inserv"
echo ""
