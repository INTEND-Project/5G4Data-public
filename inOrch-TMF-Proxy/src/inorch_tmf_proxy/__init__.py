...
from inorch_tmf_proxy.logging_config import configure_logging
from inorch_tmf_proxy.repositories.intent_repository import IntentRepository
...
from inorch_tmf_proxy.services.intent_service import IntentService
from inorch_tmf_proxy.services.k8s_deployer import KubernetesDeployer
from inorch_tmf_proxy.services.helm_deployer import HelmDeployer
...
def create_app(config: AppConfig | None = None) -> "connexion.App":
    ...
    from inorch_tmf_proxy.health import register_health_blueprint
